...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Loop — AI Adaptive Video Publisher" },
      { name: "description", content: "A self-improving video publishing platform. Every post makes the next one smarter." },
      { property: "og:title", content: "Loop — AI Adaptive Video Publisher" },
